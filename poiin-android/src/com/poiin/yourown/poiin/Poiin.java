...
public class Poiin implements JsonStringSupport {
	...
	public String toJsonString() {
		try {
			return "{user_id:" + user.getLong("id") + ",user_twitter_id:"
					+ getJsonProperty("twitter_id") + ",user_facebook_id:"
					+ getJsonProperty("facebook_id") + ",latitude:" + latitude
					+ ",longitude:" + longitude + ",user_name:"
					+ user.getString("name") + ",text:" + text + "}";
